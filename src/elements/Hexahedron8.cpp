...
Hexahedron8::Hexahedron8() : HexahedronFamily() {
...
std::vector<double> Hexahedron8::getN(const Point3D& p) {
...
std::vector<double> Hexahedron8::getdNdcsi(const Point3D& p) {
  // double csi = p.x();
  double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Hexahedron8::getdNdeta(const Point3D& p) {
  double csi = p.x();
  // double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Hexahedron8::getdNdzeta(const Point3D& p) {
  double csi = p.x();
  double eta = p.y();
  // double zeta = p.z();
...
std::vector<fem::Point3D> Hexahedron8::getLocalCoordinates() {
