...
class GmshElementExporterVisitor : public fem::mesh::ElementVisitor {
 public:
  GmshElementExporterVisitor(std::ofstream& mesh_file)
      : m_mesh_file_stream(mesh_file) {}
...
void GmshExporter::execute(std::ofstream& mesh_file,
                           const mesh::MeshModel& mesh_model) {
  // export header
