...
Eigen::VectorXd SurfaceLoad::getForceVector(Model& model) const {
  ...
  for (auto quadrature_point : getDomainQuadratureRule()) {
    // get shape function and shape function derivatives in this integration
    // Point's coordinate
