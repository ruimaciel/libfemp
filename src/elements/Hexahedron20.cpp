...
Hexahedron20::Hexahedron20() : HexahedronFamily() {
...
std::vector<double> Hexahedron20::getN(const Point3D& p) {
...
std::vector<double> Hexahedron20::getdNdcsi(const Point3D& p) {
  double csi = p.x();
  double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Hexahedron20::getdNdeta(const Point3D& p) {
  double csi = p.x();
  double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Hexahedron20::getdNdzeta(const Point3D& p) {
  double csi = p.x();
  double eta = p.y();
  double zeta = p.z();
