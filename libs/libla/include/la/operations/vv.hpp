...
Vector<scalar, VectorStoragePolicy> operator+(
    Vector<scalar, VectorStoragePolicy> v1,
    Vector<scalar, VectorStoragePolicy> v2) {
...
Vector<scalar, VectorStoragePolicy> operator*(
    scalar alpha,
    Vector<scalar, VectorStoragePolicy> v) {
...
**/
template <typename scalar, template <typename> class VectorStoragePolicy>
void Axpy(Vector<scalar, VectorStoragePolicy>& v1,
          scalar alpha,
          Vector<scalar, VectorStoragePolicy>& v2) {
  assert(v1.size() == v2.size());
...
**/
template <typename scalar, template <typename> class VectorStoragePolicy>
scalar dot(Vector<scalar, VectorStoragePolicy>& v1,
           Vector<scalar, VectorStoragePolicy>& v2) {
  assert(v1.size() == v2.size());
