...
std::vector<double> Quadrangle8::getN(const Point3D& p) const {
...
std::vector<double> Quadrangle8::getdNdcsi(const Point3D& p) const {
  double csi = p.x();
  double eta = p.y();
...
std::vector<double> Quadrangle8::getdNdeta(const Point3D& p) const {
  double csi = p.x();
  double eta = p.y();
