...
struct ElementResults {
  std::vector<Strains<double>>
      strains;  // strains calculated in each of the element's nodes
  std::vector<Stresses<double>>
      stresses;  // stresses calculated in each of the element's nodes
