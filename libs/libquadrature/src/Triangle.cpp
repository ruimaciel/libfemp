...
std::vector<TriangleRule::Point> Triangle3::operator()() const {
  return {Point{1.0 / 6, {2.0 / 3, 1.0 / 6.0}},
          Point{1.0 / 6, {1.0 / 6, 2.0 / 3.0}},
          Point{1.0 / 6, {1.0 / 6, 1.0 / 6.0}}};
}

std::vector<TriangleRule::Point> Triangle6::operator()() const {
...
std::vector<TriangleRule::Point> Triangle7::operator()() const {
