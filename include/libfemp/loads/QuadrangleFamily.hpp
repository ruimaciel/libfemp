...
#include "SurfaceLoad.hpp"

namespace fem {

class QuadrangleFamily : public SurfaceLoad {
 public:
  std::unique_ptr<quadrature::QuadrangleRule>
      m_domain_quadrature_rule;  // quadrature rule for domain calculations
 ...
 public:
   ...
   */
  std::vector<quadrature::SurfaceRule::Point> getDomainQuadratureRule()
      const override;
};
