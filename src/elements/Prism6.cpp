...
std::vector<double> Prism6::getN(const Point3D& p) {
...
std::vector<double> Prism6::getdNdcsi(const Point3D& p) {
  // double csi = p.x();
  // double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Prism6::getdNdeta(const Point3D& p) {
  // double csi = p.x();
  // double eta = p.y();
  double zeta = p.z();
...
std::vector<double> Prism6::getdNdzeta(const Point3D& p) {
  double csi = p.x();
  double eta = p.y();
  // double zeta = p.z();
