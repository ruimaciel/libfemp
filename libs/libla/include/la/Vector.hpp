...
#include "VectorStorage/Dense.hpp"
#include "VectorStorage/SparseCS.hpp"

namespace lalib {

template <typename scalar,
          template <typename> class VectorStoragePolicy = DenseVector>
class Vector : public VectorStoragePolicy<scalar> {
 public:
  ...
  /**
                          Returns the value [index,column] defined in this
     matrix
                          **/
